...
function pathToPageKey(path: string): string {
  const map: Record<string, string> = {
    ...
    '/ppa': 'permohonanPerbaikanAlat',
    '/ppa-perawatan-berkala': 'permohonanPerawatanBerkala',
    '/ppa-perbaikan-berkala': 'permohonanPerbaikanAlat',
    '/Lembur-Operator': 'lemburOperator',
    '/lembur-operator': 'lemburOperator',
