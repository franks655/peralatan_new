...
export function OilChart40() {
  ...
  const monthlyData = useMemo<MonthlyData[]>(() => {
    ...
    const targetType = normalizeOilType('Oli SAE 40');
    ...
    months.forEach(month => {
      ...
      // Filter transactions for this month and Oli SAE 40
    ...
    return (
      <Card className="h-full">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg">Grafik Oli 40</CardTitle>
