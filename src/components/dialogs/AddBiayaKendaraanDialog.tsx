...
interface AddBiayaKendaraanDialogProps {
  onSubmit: (data: Omit<BiayaKendaraan, 'id' | 'total'>) => Promise<void> | void;
...
export function AddBiayaKendaraanDialog({ onSubmit, daftarKendaraan, className }: AddBiayaKendaraanDialogProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Berhasil',
        description: 'Data biaya kendaraan berhasil ditambahkan',
      });
      setOpen(false);
      setFormData({
        noLambung: '',
      ...
      toast({
        title: 'Gagal',
        description: error?.message || 'Gagal menambahkan data biaya kendaraan.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>Tambah Biaya Kendaraan Baru</DialogTitle>
            <DialogDescription>
              Form untuk menambahkan data pengeluaran biaya kendaraan
            </DialogDescription>
          </DialogHeader>
